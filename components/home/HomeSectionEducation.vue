<template>
  <div class="bg-lightpurple section relative">
    ...
    <p class="mb-3 max-w-sm md:max-w-xl ml-auto">
      ...
      users accumulate their own <strong>personalized learning</strong> history.
      With EduVault, users permission which apps can read or write their data,
      eventually allowing them to opt in to AI services while anonymizing their
      data.
    </p>
  </div>
</template>
